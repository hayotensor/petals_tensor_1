...
python -m petals_tensor.cli.run_test_inference_validator
"""
import argparse
import logging
from petals_tensor.validator import InferenceSession
...
def main():
  ...
  peers = [
    {
      'peer_id': '12D3KooWCWrjfLzYL4zJevm35MzexAwjngE1WNPYeiHrsLTGEkoy',
      'start': 0,
      'end': 2,
    }
  ]

  outputs = model.generate(inputs, peers=peers, max_new_tokens=5)
  print("outputs", outputs)

  # outputs = model.generate(inputs, peer_id='12D3KooWCWrjfLzYL4zJevm35MzexAwjngE1WNPYeiHrsLTGEkoy', max_new_tokens=5)
  # print("outputs", outputs)
