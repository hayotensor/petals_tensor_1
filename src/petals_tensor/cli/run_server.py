...
python -m petals_tensor.cli.run_server petals-team/StableBeluga2 --public_ip [ip] --port [port] --tcp_port [tcp_port] --tcp_public_ip [tcp_public_ip]
python -m petals_tensor.cli.run_server bigscience/bloom-560m --public_ip [ip] --port [port] --tcp_port [tcp_port] --tcp_public_ip [tcp_public_ip]
python -m petals_tensor.cli.run_server petals-team/StableBeluga2 --public_ip 170.000.000.000 --tcp_public_ip 170.000.000.000 --port 30331 --tcp_port 8888
"""
import os
import argparse
import logging
