...
from petals_tensor.data_structures import RemoteModuleInfo, RemoteSpanInfo, ServerState
from petals_tensor.utils.dht import compute_spans
...
def choose_best_blocks(num_blocks: int, module_infos: List[RemoteModuleInfo]) -> List[int]:
    logger.info("choose_best_blocks")
...
def should_choose_other_blocks(
    ...
    # logger.info("should_choose_other_blocks")
