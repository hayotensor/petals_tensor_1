...
from petals_tensor.utils.misc import get_size_in_bytes
...
class Server:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.server_info = ServerInfo(
            ...
            version=petals_tensor.__version__,
        ...
        while True:
            ...
            try:
                ...
                while True:
                    ...
                    if self.validator:
                        if self._should_choose_specific_blocks():
                            logger.info("Choosing specific blocks has been updated, server will load strict blocks")
                            break
            finally:
    ...
    def _should_choose_specific_blocks(self) -> bool:
        print("_should_choose_specific_blocks")

        # if self.strict_block_indices is None:
        #     return False

        try:
            f = open('accountant.json')
            block_indices = json.load(f)
            print("block_indices", block_indices)
            try:
                self.update_strict_block_indices(block_indices)
            except Exception as e:
                print("_should_choose_specific_blocks Exception", e)
        except:
            print("account.json file not found")
            return False
