...
from petals_tensor.client.routing import RemoteSequenceManager
from petals_tensor.client.sequential_autograd import _RemoteSequentialAutogradFunction
...
class RemoteSequential(nn.Module):
    ...
    def inference_session(self, **kwargs) -> InferenceSession:
        print("inference_session.py | self", self)
        print("inference_session.py | kwargs", kwargs)
